...
public class Hashids {
  ...
  public Hashids(String salt,int minHashLength,String alphabet,String prefix){
	  this(salt,minHashLength,alphabet,prefix,true);
  }

  public Hashids(String salt, int minHashLength, String alphabet,String prefix,boolean enable) {
  ...
  public String encode(long... numbers) {
    ...
    if(this.enable){
    	res = this.prefix + this._encode(numbers);
    }
    return res;
  }
...
public long[] decode(String hash) {
    ...
    if(this.enable){
	    ...
	    res = this._decode(hash, this.alphabet);
    }else{
    	res[0] = 0L; 
    }
    return res;
  ...
  private long[] _decode(String hash, String alphabet) {
    ...
    if (!this.encode(arr).replace(this.prefix,"").equals(hash)) {
      arr = new long[0];
    }
