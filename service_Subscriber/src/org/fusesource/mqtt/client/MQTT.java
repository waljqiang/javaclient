...
public class MQTT {
    ...
    private static URI createDefaultHost() {
        try {
        	//String defaultHost = "tcp://" + mqttConf.address + ":" + mqttConf.port;
    ...
    public MQTT(UTF8Buffer clientId) {
    ...
    public MQTT(MQTT other) {
        ...
        //other.setUserName(mqttConf.username);
        //other.setPassword(mqttConf.password);
