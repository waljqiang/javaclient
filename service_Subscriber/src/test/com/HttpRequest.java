...
public class HttpRequest {
  ...
  public static String sendGet(String url, String param) {
      ...
      try {
          ...
          logger.debug("发送GET请求出现异常 "+e.getMessage());
      }
      // 使用finally块来关闭输入流
      finally {
          try {
          	...
          	logger.debug("发送GET请求出现异常2 "+e2.getMessage());
          }
      }
      return result;
  }
  	...
  	try{
          ...
          if(conn.getResponseCode() == 200){
          	...
          	try{
          		...
          		logger.error("sendpostjson failure:"+e.getMessage());
          	}
          }
  	}catch(Exception e){
  		logger.error("sendpostjson exception:"+e.getMessage());
  	}
  	return result;
  }
  
  public static String sendPostJson(String url,Map<String,String> properties,String jsonStr){
	   	String result = "";
	   	try{
	   		if(url.substring(0,5).equals("https")){
	   			HttpRequest.trustAllHttpsCertificates();
	           ...
	           if(conn.getResponseCode() == 200){
	           	...
	           	try{
	           		...
	           		//Helper.log(e.getMessage(),"info", log);
	           	}
	           }
	   	}catch(Exception e){
	   		//Helper.log(e.getMessage(),"info",log);
  ...
  public static String sendPost(String url, String param) {
      ...
      //使用finally块来关闭输出流、输入流
          ...
          try{
       	   ...
       	   logger.error("发送POST请求出现异常2 "+ex.getMessage());
          }
      }
      return result;
  }    
  ...
  public static String sendGet_base(String url) {
      ...
      // 使用finally块来关闭输入流
          ...
          try {
       	   ...
       	   logger.error("发送GET请求出现异常2 "+e2.getMessage());
          }
      }
      return result;
  }
